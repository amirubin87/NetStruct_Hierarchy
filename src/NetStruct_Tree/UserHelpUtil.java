...
public class UserHelpUtil {
	public final static String helpMsg = 
			...
			+ "minSizeOfCommToBrake (-minb) -\n\t\t an int, the minimum amount of nodes in a community in order to brake it to sub-communities. Default - 20. \n"
			+ "minSizeOfCommToOutput (-mino) -\n\t\t an int, the minimum amount of nodes in a community in order to output it. Default - 20. \n"			
	...
	public final static String paramMsg = 
			...
			+ "java -jar NetStruct_Tree_v1.jar -ss 0.0001 -dy true -mod true -minb 20 -mino 20 -b 1.0"
			+ " -pro C:/Data/ -skip false -pca placeholder -pm C:/Data/Matrix.txt"
			+ " -pe placeholder -pmn C:/Data/indlist.txt -pss C:/Data/SampleSites.txt -nvl 0 -w true -ls false -pts false -indtoex placeholder\n";
